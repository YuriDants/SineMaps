...
public class ListarCGActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HttpGetAsyncTask httpGetAsyncTask = new HttpGetAsyncTask(null, 2);
        ...
        try {
            httpGetAsyncTask.execute("http://mobile-aceite.tcu.gov.br/mapa-da-saude/rest/emprego/latitude/-7.242662/longitude/-35.9716057/raio/100").get();
